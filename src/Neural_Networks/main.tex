...
\begin{titlepage}
    ...
    \begin{flushleft}
        ...
        % Titolo Principale 
        \textcolor{colorE}{\sffamily\fontsize{60}{70}\selectfont\textbf{Neural}}\\[0.1cm]
        \textcolor{colorE}{\sffamily\fontsize{60}{70}\selectfont\textbf{Networks}}\\[0.6cm]
        \textcolor{white!80}{\sffamily\Large Appunti del corso del prof. Maurizio Mattia}\\[0.5cm]
    ...
    \begin{flushleft}
        ...
        \textcolor{white}{\sffamily\Large\textbf{2023/2024}}
    \end{flushleft}
