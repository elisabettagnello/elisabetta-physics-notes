...
\begin{figure}[h!]
\centering
 \includegraphics[width=0.4\textwidth]{pics/23_1} % INSERIRE QUI LO SCHEMA DELL'AMMINOACIDO
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.6\textwidth]{pics/23_2} % INSERIRE QUI IL GRAFICO DELLA DESIGNABILITY
