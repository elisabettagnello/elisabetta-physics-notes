...
\begin{tikzpicture}[scale=1.5]
    % Piani
    \draw[thick, colorB] (0,0) -- (6,0);
    \draw[thick, colorB] (0,-1.5) -- (6,-1.5);
    \draw[<->] (5.5,0) -- (5.5,-1.5) node[midway, right] {$d$};
    
    % Atomi
    \foreach \x in {1, 2.5, 4, 5.5} {
        \filldraw[colorA] (\x,0) circle (2pt);
        \filldraw[colorA] (\x,-1.5) circle (2pt);
    }
    
    % Raggio 1
    \draw[->, thick, colorE] (0.5, 1) -- (2.5,0);
    \draw[->, thick, colorE] (2.5, 0) -- (4.5,1) node[right] {Raggio 1};
    
    % Raggio 2
    \draw[->, thick, colorF] (0.5, 0) -- (2.5,-1.5);
    \draw[->, thick, colorF] (2.5, -1.5) -- (4.5,0) node[above] {Raggio 2};
    
    % Angoli (theta)
    \draw (1.8,0) arc (180:153:0.7);
    \node at (1.5, 0.15) {$\theta$};
    \draw (3.2,0) arc (0:27:0.7);
    \node at (3.5, 0.15) {$\theta$};
    
    % Differenza di cammino (perpendicolari)
    \draw[dashed, thick] (2.5,0) -- (1.75,-0.75);
    \draw[dashed, thick] (2.5,0) -- (3.25,-0.75);
    
    % Evidenzia la differenza di cammino
    \draw[ultra thick, colorD] (1.75,-0.75) -- (2.5,-1.5) node[midway, below left] {$d\sin\theta$};
    \draw[ultra thick, colorD] (2.5,-1.5) -- (3.25,-0.75) node[midway, below right] {$d\sin\theta$};
\end{tikzpicture}
\end{center}
\vspace{0.5cm}
