...
\begin{itemize}
  ...
  \item Dà $n_i$ (o $n_c$) a \textbf{due} temperature diverse? Ricava $E_g$ con il metodo esatto o approssimato pi\`u sotto).
...
\textbf{Passo 6b ($\mu$):} regime estrinseco saturo $\implies\ \mu=E_g-\kB T\ln(N_c/N_D)$, con $N_c$ calcolato dalla Tabella con $m_c^*$ a $T=300$ K.
...
$v_F=\hbr k_F/m^*$, quindi $\lambda = v_F\tau = \dfrac{\hbr k_F}{m^*}\cdot\dfrac{\mu m^*}{e}
