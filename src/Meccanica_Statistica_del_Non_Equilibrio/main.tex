...
\begin{titlepage}
    ...
    \begin{flushleft}
        ...
        % Titolo Principale 
        \textcolor{colorE}{\sffamily\fontsize{60}{70}\selectfont\textbf{Meccanica Statistica del}}\\[0.1cm]
        \textcolor{colorE}{\sffamily\fontsize{60}{70}\selectfont\textbf{Non Equilibrio}}\\[0.6cm]
...
Il presente documento costituisce una raccolta di appunti personali presi durante le lezioni del corso di \textit{Statistical Mechanics and Critical Phenomena}. 
